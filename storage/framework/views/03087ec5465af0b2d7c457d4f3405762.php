                    ...
                    <form method="POST" action="/register">
                        ...
                        <label class="floating-label mb-6">
                            <input type="text"
                                   ...
                                   class="input input-bordered <?php $__errorArgs = ['name'];
...
<?php endif; ?>
<?php /**PATH N:\Docker\docker-lamp\docker-compose-lamp\www\chirper\resources\views/auth/register.blade.php ENDPATH**/ ?>